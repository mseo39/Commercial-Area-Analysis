...
@shared_task
def market_uploaded_file(readLine,country,city):
...
@shared_task
def sales_uploaded_file(readLine,country,city):
...
@shared_task
def apart_uploaded_file(readLine,country,city):
...
@shared_task
def people_uploaded_file(readLine, country, city):
